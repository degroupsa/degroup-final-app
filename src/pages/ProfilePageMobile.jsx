  ...
  return (
    <div className={styles.profilePageMobile}>
      ...
      <nav className={styles.contentNav}>
        ...
        {isOwner && (
          <>
            <button onClick={() => setActiveView('orders')} className={activeView === 'orders' ? styles.active : ''}><FaBoxOpen/> Pedidos</button>
            <button onClick={() => setActiveView('security')} className={activeView === 'security' ? styles.active : ''}><FaShieldAlt/> Seguridad</button>
          </>
        )}
      </nav>
